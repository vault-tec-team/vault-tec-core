...
contract MultiRewardsLiquidityMiningManagerV2 is TokenSaver {
    ...
    function removePool(uint256 _poolId) external onlyGov {
        require(_poolId < pools.length, "MultiRewardsLiquidityMiningManagerV2.removePool: Pool does not exist");
        distributeRewards();
    ...
    function adjustWeight(uint256 _poolId, uint256 _newWeight) external onlyGov {
        require(_poolId < pools.length, "MultiRewardsLiquidityMiningManagerV2.adjustWeight: Pool does not exist");
        distributeRewards();
