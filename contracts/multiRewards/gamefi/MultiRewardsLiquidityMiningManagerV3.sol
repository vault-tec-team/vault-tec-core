...
contract MultiRewardsLiquidityMiningManagerV3 is TokenSaver {
    ...
    modifier onlyRewardDistributor {
        require(hasRole(REWARD_DISTRIBUTOR_ROLE, _msgSender()), "MultiRewardsLiquidityMiningManagerV3.onlyRewardDistributor: permission denied");
        _;
    }

    modifier onlyFeeManager {
        require(hasRole(FEE_MANAGER_ROLE, _msgSender()), "MultiRewardsLiquidityMiningManagerV3.onlyFeeManager: permission denied");
        _;
    }
    ...
    constructor(
        ...
        require(_rewardSource != address(0), "MultiRewardsLiquidityMiningManagerV3.constructor: rewardSource must be set");
    ...
    function addPool(address _poolContract, uint256 _weight) external onlyGov {
        ...
        require(pools.length < MAX_POOL_COUNT, "MultiRewardsLiquidityMiningManagerV3.addPool: Max amount of pools reached");
        // add pool
        pools.push(Pool({
