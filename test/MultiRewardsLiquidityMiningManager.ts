...
describe("LiquidityMiningManager - MultiRewards", function () {
    ...
    describe("Adding pools", async() => {
        ...
        it("Adding a pool twice should fail", async() => {
            ...
            await expect(liquidityMiningManager1.addPool(pools[0].address, 0)).to.be.revertedWith("LiquidityMiningManager.addPool: Pool already added");
        });

        it("Adding a pool from a non gov address should fail", async() => {
            await expect(liquidityMiningManager1.connect(account2).addPool(pools[0].address, 0)).to.be.revertedWith("LiquidityMiningManager.onlyGov: permission denied");
        });
    });
    ...
    describe("Removing pools", async() => {
        ...
        it("Removing a pool from a non gov address should fail", async() => {
            await expect(liquidityMiningManager1.connect(account2).removePool(0)).to.be.revertedWith("LiquidityMiningManager.onlyGov: permission denied");
        });
    });
    ...
    describe("Distributing rewards", async() => {
        ...
        it("Distributing rewards from an address which does not have the REWARD_DISTRIBUTOR_ROLE", async() => {
            await expect(liquidityMiningManager1.connect(account2.address).distributeRewards()).to.revertedWith("LiquidityMiningManager.onlyRewardDistributor: permission denied");
        });
    ...
    describe("Adjusting weight", async() => {
        ...
        it("Should fail from non gov address", async() => {
            await expect(liquidityMiningManager1.connect(account2).adjustWeight(0, 0)).to.be.revertedWith("LiquidityMiningManager.onlyGov: permission denied");
        });
    ...
    describe("Setting reward per second", async() => {
        ...
        it("Should fail from non gov address", async() => {
            await expect(liquidityMiningManager1.connect(account2).setRewardPerSecond(0)).to.be.revertedWith("LiquidityMiningManager.onlyGov: permission denied");
        });
    });
