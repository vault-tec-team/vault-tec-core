...
describe("LiquidityMiningManager - MultiRewards", function () {
    ...
    describe("Update rewardSource", async () => {
        ...
        it("Update rewardSource from a non gov address should fail", async () => {
            await expect(liquidityMiningManager1.connect(account2).updateRewardSource(account4.address)).to.be.revertedWith("MultiRewardsLiquidityMiningManagerV3.onlyGov: permission denied");
        });
